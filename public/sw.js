self.__TS_SW_VERSION__ = "20260426-founder-control-fix-1";
...
const CORE_ASSETS = [
  ...
  "/Script.js?v=20260426-founder-control-fix-1",
  "/api.js?v=20260425-foundation-security-1",
  "/backend-adapter.js?v=20260425-founder-control-room-1",
  "/founder-control.js?v=20260426-founder-control-fix-1",
  ...
  "/enhancements-bootstrap.js?v=20260426-founder-control-fix-1",
  "/noncritical-enhancements.js?v=20260426-founder-control-fix-1",
];
